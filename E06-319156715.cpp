...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f,  -0.5f,  0.5f,	0.75f,	0.32f,		0.0f,	1.0f,	0.0f,
		 0.5f,  -0.5f,  -0.5f,	0.75f,	0.01f,		0.0f,	1.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado-opti.png");
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/dado-opti.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Dado importado
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-4.0f, 4.5f, -2.0f));
