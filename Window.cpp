...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_Z)
	{
		theWindow->avanzax -= 0.1f;
	}
	if (key == GLFW_KEY_X)
	{
		theWindow->retrocedex += 0.1; 
	}
	...
	if (key == GLFW_KEY_F)
	{
		if (theWindow->articulacion1 < 45.0 && theWindow->bandera1==0){
			theWindow->articulacion1 += 2.0;
		}
		else if(theWindow->articulacion1 >= 45.0){
			theWindow->bandera1 = 1;
			theWindow->articulacion1 -= 2.0;
		}
		else if(theWindow->articulacion1 > -2.0 && theWindow->bandera1 ==1){
			theWindow->articulacion1 -= 2.0;
		}
		else{
	...
	if (key == GLFW_KEY_K)
	{
		if (theWindow->articulacion5 < 45.0 && theWindow->bandera5 == 0) {
			theWindow->articulacion5 += 5.0;
		}
		else if (theWindow->articulacion5 == 45.0) {
			theWindow->bandera5 = 1;
			theWindow->articulacion5 -= 5.0;
		}
		else if (theWindow->articulacion5 > -45.0 && theWindow->bandera5 == 1) {
			theWindow->articulacion5 -= 5.0;
		}
		else {
