...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::translate(model, glm::vec3(-2.0f, -0.5f, 1.7f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta1()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta2()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.3f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::translate(model, glm::vec3(2.0f, -0.5f, -1.6f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta3()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.3f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::translate(model, glm::vec3(2.0f, -0.5f, 1.7f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta4()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.3f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = centro; // para volver a cabina
		//Articulación 1: Cabina-Brazo
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacionG1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		...
		//Articulación 2
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacionG2()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacionG3()), glm::vec3(0.5f, 0.5f, 1.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacionG4()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//oreja 1
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.5f, 1.4f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta1()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.949f, 0.89f, 0.063f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		model = modelaux;
		...
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.949f, 0.788f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		model = modelaux;
		...
		model = glm::rotate(model, glm::radians(mainWindow.getcompleta3()), glm::vec3(1.0f, 0.0f,0.0f));
		modelaux = model;
